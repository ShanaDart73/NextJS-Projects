  ...
  return (
    <div className="my-10 px-4 overflow-x-scroll scrollbar-hide">
      <div className="flex gap-4 md:gap-8">
        <div className="flex-shrink-0 w-full sm:w-1/2 lg:w-1/4 xl:w-1/6">
          <Link href="/e-commerce/list?cat=test">
          ...
          <h1 className="mt-8 font-light text-lg xl:text-2xl text-clip tracking-wide">
            Category Name
          </h1>
        </div>
        <div className="flex-shrink-0 w-full sm:w-1/2 lg:w-1/4 xl:w-1/6">
